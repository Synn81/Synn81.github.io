  ...
  return (
    ...
    >
      ...
      <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
        Get notified of the latest on The Sae Scroll Prophecies and more, unsubscribe at any time.
      </p>
...
function Resume() {
  let resume = [
    {
      project: 'The Sae Scroll Prophecies',
      logo: synn,
      start: '2023',
    }
  ]
        ...
        {resume.map((role, roleIndex) => (
          <li key={roleIndex} className="flex gap-4">
            <div className="relative mt-1 flex h-10 w-10 flex-none items-center justify-center rounded-full shadow-md shadow-zinc-800/5 ring-1 ring-zinc-900/5 dark:border dark:border-zinc-700/50 dark:bg-zinc-800 dark:ring-0">
              <Image src={role.logo} alt="" className="rounded-full bg-zinc-100 object-cover dark:bg-zinc-800" unoptimized />
            </div>
